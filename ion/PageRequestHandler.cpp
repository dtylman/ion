...
PageRequestHandler::PageRequestHandler() : _logger(Poco::Logger::get("PageRequestHandler"))
{
}
...
void PageRequestHandler::setContentType(Poco::Net::HTTPServerRequest& request, Poco::Net::HTTPServerResponse& response)
{
