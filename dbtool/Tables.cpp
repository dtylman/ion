...
void Tables::create()
{
    ...
    _session << "CREATE TABLE authorized_traffic (type TEXT NOT NULL, value TEXT NOT NULL)", now;
    _session << "CREATE UNIQUE INDEX pk_authorized_traffic on authorized_traffic (type ASC, value ASC)", now;
